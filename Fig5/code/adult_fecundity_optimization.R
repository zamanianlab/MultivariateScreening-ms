...
data <- read_rds(here("Fig5/data/fecundity_data.rds")) %>%
...
save_plot(here("Fig5/subplots/Fig5d.pdf"), zero_hour, base_width = 4, base_height = 4)
write_rds(zero_hour, here("Fig5/subplots/baseline_fecundity.rds"))
...
save_plot(here("Fig5/subplots/Fig5c.pdf"), optimization_plot, base_width = 4, base_height = 4)
saveRDS(optimization_plot, here("Fig5/subplots/optimized_fecundity.rds"))
...
save_plot(here("Fig5/supplementary/SupplementaryFig4.pdf"), batch, base_width = 6, base_height = 6)
