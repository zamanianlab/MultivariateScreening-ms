...
all_data <- read_rds(here('Fig5/data/metabolism_data.rds'))
...
save_plot(here("Fig5/subplots/Fig5b.pdf"), hk, base_width = 3, base_height = 2)
write_rds(hk, here("Fig5/subplots/heatkilled_metabolism.rds"))
