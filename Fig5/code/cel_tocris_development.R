...
pruned_data <- read_rds(here("Fig5/data/cel_tocris_development_data.rds"))
...
save_plot(here("Fig5/subplots/Fig5a.pdf"), z_plot, base_width = 6, base_height = 6)
write_rds(z_plot, here("Fig5/subplots/cel_screen_dev.rds"))
...
save_plot(here("Fig5/subplots/Fig5b.pdf"), followup_plot, base_width = 6, base_height = 8)
write_rds(followup_plot, here("Fig5/subplots/cel_followup.rds"))
...
cel_hits <- bind_rows(one_hits, ten_hits) %>%
  write_rds(here("Fig5/data/cel_hits.rds"))
