...
save_plot(here("Fig4/subplots/Fig4a.pdf"), end_bar, base_width = 8, base_height = 6)
write_rds(end_bar, here("Fig4/subplots/motility.rds"))
...
out <- treatment_summary %>%
  ...
  write_rds(here("Fig4/data/adult_motility_data.rds"))

write_rds(end_hits, here("Fig4/data/motility_hits.rds"))
...
write_rds(end_data, here("Fig4/data/motility_end.rds"))
