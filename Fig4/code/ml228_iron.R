...
pruned_data <- read_rds(here('Fig4/data/hypoxia_data.rds'))
...
save_plot(here('Fig4', 'subplots', 'Fig4e.pdf'),
          curve_plot,
          base_height = 3, base_width = 4)

write_rds(curve_plot, here('Fig4', 'subplots', 'k_s_media.rds'), compress = 'gz')
