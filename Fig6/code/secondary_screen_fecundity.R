...
pixel_data <- read_rds(here("Fig6/data/raw_fecundity_data.rds"))

model <- read_rds(here("Fig6/data/fecundity_model.rds"))
...
write_rds(baseline, here("Fig6/subplots/baseline.rds"))
save_plot(here("Fig6/subplots/Fig6c_inset.pdf"), baseline, base_width = 3)
...
save_plot(here("Fig6/subplots/Fig6c.pdf"), proportions_plot, base_width = 7)
write_rds(proportions_plot, here("Fig6/subplots/proportions.rds"))
...
write_rds(prop_summary, here("Fig6/data/prop_summary.rds"))
write_rds(proportions, here("Fig6/data/proportions.rds"))

write_rds(fecundity_hits, here("Fig6/data/fecundity_hits.rds"))
