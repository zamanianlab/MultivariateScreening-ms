...
tidy_data <-
  read_rds(here("Fig6/data/lactate_data.rds")) %>%
...
save_plot(here('Fig6/subplots/Fig6d.pdf'), lactate_plot, base_width = 7)
write_rds(lactate_plot, here("Fig6/subplots/lactate.rds"))

write_rds(metabolism_hits, here("Fig6/data/metabolism_hits.rds"))
